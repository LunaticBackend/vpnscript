...
echo -e "SSH Websocket Direct & enanched: 8080,8880"
echo -e "OPEN VPN: 1194"
echo -e "BadVPN UDPGW: 7100,7200,7300"
echo -e "Proxy CloudFront: [ON]"
...
echo -e "=================================================="
echo -e "PATCH /ssh-wongedan HTTP/1.1[crlf]Host: [host][crlf]Host: ISIBUG[crlf]Upgrade: websocket[crlf]Connection: Upgrade[crlf]User-Agent: [ua][crlf][crlf]"
echo -e "=================================================="
echo -e "${CYAN}     Terimakasih sudah menggunakan"
echo -e "${CYAN}        script Lunatic Tunneling"
echo -e "${LIGHT}=================================================="