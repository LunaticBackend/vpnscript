...
wget -O /etc/pam.d/common-password "https://raw.githubusercontent.com/LunaticBackend/vpnscript/mytich/ws/password.txt"
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/LunaticBackend/vpnscript/mytich/conf/nginx.conf"
...
cd
cd
wget -O /usr/bin/badvpn-udpgw https://raw.githubusercontent.com/LunaticBackend/vpnscript/mytich/conf/badvpn-udpgw && chmod +x  /usr/bin/badvpn-udpgw
#system badvpn 7300
wget -O /etc/systemd/system/svr-7300.service https://raw.githubusercontent.com/LunaticBackend/vpnscript/mytich/conf/svr-7300.service && chmod +x  /etc/systemd/system/svr-7300.service
#system badvpn 7200
wget -O /etc/systemd/system/svr-7200.service https://raw.githubusercontent.com/LunaticBackend/vpnscript/mytich/conf/svr-7200.service && chmod +x  /etc/systemd/system/svr-7200.service
#system badvpn 7100
wget -O /etc/systemd/system/svr-7100.service https://raw.githubusercontent.com/LunaticBackend/vpnscript/mytich/conf/svr-7100.service && chmod +x  /etc/systemd/system/svr-7100.service
...
wget https://raw.githubusercontent.com/LunaticBackend/vpnscript/mytich/scurity/rules.zip
unzip rules.zip
...
echo; echo 'Installing DDOS-protevtion v.10 by LunaticBackend'; echo
...
wget -q -O /etc/cyber.site "https://raw.githubusercontent.com/LunaticBackend/vpnscript/mytich/issue.net"
...
wget https://raw.githubusercontent.com/LunaticBackend/vpnscript/mytich/ws/bbr.sh && chmod +x bbr.sh && ./bbr.sh
...
iptables -I INPUT -m state --state NEW -m tcp -p tcp --dport 80 -j ACCEPT
    ...
    #iptables -I INPUT -m state --state NEW -m tcp -p tcp --dport 58080 -j ACCEPT
    #iptables -I INPUT -m state --state NEW -m udp -p udp --dport 58080 -j ACCEPT
    ...
    #iptables -I INPUT -m state --state NEW -m tcp -p tcp --dport 36712 -j ACCEPT
    #iptables -I INPUT -m state --state NEW -m udp -p udp --dport 36712 -j ACCEPT
    #iptables -I INPUT -m state --state NEW -m tcp -p tcp --dport 5300 -j ACCEPT
    ...
    #iptables -I INPUT -m state --state NEW -m udp -p udp --dport 1723 -j ACCEPT
    #iptables -I INPUT -m state --state NEW -m tcp -p tcp --dport 1701 -j ACCEPT
    #iptables -I INPUT -m state --state NEW -m udp -p udp --dport 1701 -j ACCEPT
    ...
    #iptables -I INPUT -m state --state NEW -m tcp -p tcp --dport 2001 -j ACCEPT
    #iptables -I INPUT -m state --state NEW -m udp -p udp --dport 2001 -j ACCEPT

#iptables -I INPUT -m state --state NEW -m tcp -p tcp --dport 1010 -j ACCEPT
    #iptables -I INPUT -m state --state NEW -m udp -p udp --dport 1010 -j ACCEPT
...
printf "q\n" | rclone config
wget -O /root/.config/rclone/rclone.conf "https://raw.githubusercontent.com/LunaticBackend/ScLt/main/Cfg/rclone.conf"
