...
export Server_URL="https://raw.githubusercontent.com/LunaticBackend/vpnscript/mytich/"
export Server1_URL="https://raw.githubusercontent.com/LunaticBackend/vpnscript/mytich/"
...
wget -q -O /usr/bin/lock "https://raw.githubusercontent.com/LunaticBackend/vpnscript/mytich/limit/user-lock.sh" && chmod 777 /usr/bin/lock

wget -q -O /usr/bin/unlock "https://raw.githubusercontent.com/LunaticBackend/vpnscript/mytich/limit/user-unlock.sh" && chmod 777 /usr/bin/unlock
...
echo -e "\E[44;1;39m                         ⇱ USER EXPIRED  ⇲                         \E[0m"
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
...
read -p "${BIWhite}Input username for recovery account: " Login
read -p "${BIWhite}Input new password: " Pass
read -p "${BIWhite}Expired days: " masaaktif
...
echo -e ""
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
echo -e "\E[44;1;39m                 ⇱ RECOVERY AKUN SSH ⇲            \E[0m"
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
