...
BURIQ () {                                           curl -sS  https://raw.githubusercontent.com/LunaticBackend/regip/mytich/ipreg > /root/tmp
...
Name=$(curl -sS curl -sS  https://raw.githubusercontent.com/LunaticBackend/regip/mytich/ipreg | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
MYIP=$(curl -sS ipv4.icanhazip.com)
IZIN=$(curl -sS curl -sS  https://raw.githubusercontent.com/LunaticBackend/regip/mytich/ipreg | awk '{print $4}' | grep $MYIP)
if [ "$MYIP" = "$IZIN" ]; then
Bloman
else
...
echo -e "${GREEN}| \E[44;1;39m           • LUNATIC TUNNELING •          \E[0m|"
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
echo -e ""
